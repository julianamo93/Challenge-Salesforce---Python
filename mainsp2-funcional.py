...
def exibir_informacoes_alto_contraste():
    ...
    pygame.init()
    fonte = pygame.font.Font(None, 36)  # Defina o tamanho da fonte como desejado

    tela = pygame.display.set_mode((800, 600))
    clock = pygame.time.Clock()

    texto_alto_contraste = fonte.render("MODO ALTO CONTRASTE", True, (0, 0, 0), (255, 255, 255))  # Cor branca sobre fundo preto
    while True:
        ...
        tela.blit(texto_alto_contraste, (100, 100))
...
def aumentar_tamanho_fonte():
    ...
    texto_grande = fonte.render("MENU ACESSÍVEL SALESFORCE", True, (255, 255, 255))  # Cor branca
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit()
        ...
        tela.blit(texto_grande, (100, 100))
...
def diminuir_tamanho_fonte():
    ...
    pygame.init()
    fonte = pygame.font.Font(None, 18)  # Defina o tamanho da fonte como desejado

    tela = pygame.display.set_mode((800, 600))
    clock = pygame.time.Clock()

    texto_pequeno = fonte.render("menu acessível salesforce", True, (255, 255, 255))  # Cor branca
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                pygame.quit()
        ...
        tela.fill((0, 0, 0))  # Cor de fundo preta
        tela.blit(texto_pequeno, (100, 100))
